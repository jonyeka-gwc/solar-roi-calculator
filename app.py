...
if st.session_state.usage_type == 'low':
    ...
    **Approximate annual usage: 3,500 kWh electricity.**
    """)
    annual_usage = 3500
    ...
    **Approximate annual usage: 5,500 kWh electricity.**
    """)
    annual_usage = 5500
    ...
    annual_usage = st.number_input(
        ...
        min_value=1000,
        max_value=20000,
        value=st.session_state.annual_usage if st.session_state.annual_usage not in [2000, 3500, 5500] else 3500,
        step=100,
        help="You can find this on your electricity bill or smart meter app"
    )
    st.session_state.annual_usage = annual_usage
